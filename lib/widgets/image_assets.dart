...
class ImageAssets {
  ...
  static const String unMaxButton = 'assets/unmaxbutton.png';
  static const String title = 'assets/title.png'; // 默认图片路径
  static const String lightSuffix = 'Light.png';  // 图片路径后缀
}